  ...
  return (
    <div className="w-full md:py-20">
      <Wrapper>
        {cartItems.length > 0 && (
          <>
            <div className="text-center max-w-[50rem] mx-auto mt-8 md:mt-0">
              <div className="text-[1.75rem] md:text-[2.125rem] mb-5 font-semibold leading-tight">
                Shopping Cart
              </div>
            </div>

            <div className="flex flex-col md:flex-row gap-12 py-10 lg:ml-1">
              ...
              <div className="flex-[1]">
                ...
                <button
                  ...
                  className="w-full py-4 rounded-full bg-black text-white text-lg font-medium transition-transform active:scale-95 hover:opacity-75 flex flex-row items-center justify-center"
                >
